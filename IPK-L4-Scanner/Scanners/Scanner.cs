...
class Scanner : IDisposable
{
    ...
    private IHeaderFactory packetFactory;
    ...
    public Scanner(string interfaceName, IPAddress destinationIp, IHeaderFactory headerFactory, int timeout = 5000, int delayBetweenScans = 0)
    {
